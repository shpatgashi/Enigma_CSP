...
constraints = [
    ...
    Constraint(c1={'nationality': 'Norway'}, offset=0),
    Constraint(c1={'drink': 'Milk'}, offset=2),
    ...
    Constraint(c1={'drink': 'Orange Juice'}, c2={'cigarette': 'Lucky Strike'}, offset=0),
    # Konsumuesi i duhanit Lucky Strike pi lëng portokalli.
    ...
    Constraint(c1={'color': 'Ivory'}, c2={'color': 'Green'}, offset=1),
    # Shtëpia e gjelbër është menjëherë në të djathtë të shtëpisë së fildishtë.
    Constraint(c1={'cigarette': 'Chesterfield'}, c2={'pet': 'Fox'}, offset=[-1, 1]),
    # Njeriu që pi duhan Chesterfields jeton në shtëpinë pranë burrit me dhelpra.
    Constraint(c1={'nationality': 'Norway'}, c2={'color': 'Blue'}, offset=[-1, 1]),  # Norvegjiani jeton pranë shtëpisë blu.
    Constraint(c1={'cigarette': 'Marlboro'}, c2={'pet': 'Horse'}, offset=[-1, 1]),
    # Marlboro konsumohet në shtëpinë pranë shtëpisë ku mbahet kali.
]
...
def eligible_to_put_in_house(constraint: Constraint, house) -> Tuple[bool, Optional[House]]:
    ...
    if constraint.offset == 0:
        ...
        # offseti tregon sa eshte shpia e DYTE larg te PARES gjith
